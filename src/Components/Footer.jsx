...
const Footer = () => {
  return (
    <footer className="grid md:grid-cols-3 bg-orange-300 text-white md:p-8 p-4">
      ...
      <figure className="grid md:grid-cols-2 grid-cols-1 col-span-3 md:col-span-1 py-2">
        <div className="text-yellow-950">
          <h1 className="text-yellow-950 font-bold text-2xl"> About Us</h1>
        ...
        <div className="text-yellow-950">
          <h1 className="text-yellow-950 font-bold text-2xl"> Quick Links </h1>
            <div className="pl-3 my-2">
        ...
        <div className="text-yellow-950 ">
          <h1 className="text-yellow-950 font-bold text-2xl"> Useful Links </h1>
            <div className="pl-3 my-2">
              <p>Blog </p>
              <p>Testimonias</p>
            </div>
