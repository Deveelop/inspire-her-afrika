...
const About = () => {
  return (
    ...
    <HeroAbout/>
    <div className=' m-auto w-[75%] mb-20'>
    <div className="  items-center flex flex-col justify-center ">
        ...
        <div className=" space-y-5 md:space-y-0 md:flex justify-center gap-6">
        <div className=" md:w-[35%]  bg-white border-t-8 border-[#EB643F] shadow-sm rounded-md shadow-gray-500">
          <div className=" p-4 font-semibold flex justify-center flex-col gap-4 items-center ">
         ...
         <div className=" md:w-[35%]  bg-white border-t-8 border-[#00E9F8] shadow-sm rounded-md shadow-gray-500">
          <div className="p-4 font-semibold flex justify-center flex-col gap-4 items-center ">
         ...
         <div className="  space-y-5 md:space-y-0 md:flex justify-between gap-6 mt-10 mb-10">
         <div className=" md:w-[35%] bg-white border-t-8 border-[#964C9A] shadow-sm rounded-md shadow-gray-500">
          <div className="p-4 font-semibold flex justify-center flex-col gap-4 items-center ">
         ...
         <div className=" md:w-[35%] bg-white border-t-8 border-[#3F46EB] shadow-sm rounded-md shadow-gray-500">
          <div className="p-4 font-semibold flex justify-center flex-col gap-4 items-center ">
         ...
         <div className=" md:w-[35%]  bg-white border-t-8 border-[#4C9A54] shadow-sm rounded-md shadow-gray-500">
          <div className="p-4 font-semibold flex justify-center flex-col gap-4 items-center ">
